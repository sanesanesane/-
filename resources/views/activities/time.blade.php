  ...
  <select class="block appearance-none w-1/3 bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" id="category_id" name="category_id"> 
    ...
    @endforeach
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div>
                                    <input type="datetime-local" class="shadow appearance-none border rounded py-2 px-3 text-gray-350 leading-tight focus:outline-none focus:shadow-outline w-1/5" id="start_time" name="start_time" onchange="calculateEndTime()" required>
                                </div>
                            ...
                            <div class="form-group mb-6">
                                ...
                                <div>
                                <input type="number" class="shadow appearance-none border rounded py-2 px-3 text-gray-350 leading-tight focus:outline-none focus:shadow-outline w-1/5" id="duration" name="duration" onchange="calculateEndTime()" placeholder="勉強時間" required>    
                                </div>
