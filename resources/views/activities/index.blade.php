        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                        ...
                        <div class="grid lg:grid-cols-1 md:grid-cols-2 sm:grid-cols-1 gap-4">
                            <form method="GET" action="{{ route('activities.index') }}">
                                <select name="category_id"
                                    class="col-span-3 appearance-none w-1/2 bg-gray-200 text-gray-700 border border-gray-200 rounded py-2 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                    ...
                    <!-- 日付順に並べる機能 -->
                    <div class="mb-4">
                        <a href="{{ route('activities.index', ['sort' => 'date_desc'] + request()->except('sort')) }}"
                            class="pr-1">
                            <x-serch-button class="py-2">
                                日付昇順
                            </x-serch-button>
                        </a>
                        <a href="{{ route('activities.index', ['sort' => 'date_asc'] + request()->except('sort')) }}"
                            class="pr-1">
                            <!---ソートをdate_ascに変更--->
                            <x-serch-button class="py-2">
                                日付降順
